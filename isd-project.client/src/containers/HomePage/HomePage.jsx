    ...
    return (
        <section className="font-[Inter] pb-10">
            ...
            <div class="w-3/4 grid grid-cols-3 gap-20 mx-auto ">
                <div className="bg-gray-200 h-510 rounded p-5 shadow-xl shadow-slate-300 hover:shadow-slate-400 duration-300 cursor-pointer">
            ...
            <button className="bg-red-500 mx-auto flex item-center justify-center mt-20 px-5 py-3 text-2xl rounded-3xl text-white shadow-lg shadow-slate-400 
                                hover:bg-red-700 active:bg-red-700 active:shadow-lg duration-300">
                    Xem them
                </button>
        </section>
    )
