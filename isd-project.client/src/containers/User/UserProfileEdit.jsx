        ...
        <section className="bg-gray-100  bg-opacity-50 h-screen h-auto">
            ...
            <div className="mx-auto container max-w-full md:w-3/4 shadow-md mt-5 mb-5 shadow rounded-lg border">
                ...
                <div className="bg-white space-y-6">
                    ...
                    <hr />
                    <div className="md:inline-flex w-full space-y-4 md:space-y-0 p-8 text-black-500 items-center">
                        ...
                        <div className="md:w-3/12 text-center md:pl-6">
                            <button className="text-white w-full mx-auto max-w-sm rounded-md text-center bg-indigo-400 hover:bg-primary-800 py-2 px-4 inline-flex items-center focus:outline-none md:float-right">
                                <svg
                                    fill="none"
