...
export function EditCustomer(
    {isOpen, handleClose, handleSubmit, editRef,
     id, fname, setFName, lname, setLName, email, setEmail, status, setStatus}) 
{
    return (
                        ...
                        <div className="p-6 space-y-6">
                            <form action="#" onSubmit={(e) => handleSubmit(e)}>
                                <div className="grid grid-cols-6 gap-6 mb-7">
                                    ...
                                    <div className="col-span-6 sm:col-span-3">
                                        <label htmlFor="email" className="block mb-2 text-sm font-medium text-gray-900">Status</label>
