...
export function DeleteCustomer({isOpen, handleClose, handleSubmit, deleteRef, id}) {
    return (
                ...
                <div ref={deleteRef} className="relative w-full h-full max-w-md px-4 md:h-auto">
                    ...
                    <div className="relative bg-white rounded-lg shadow">
                        ...
                        <div className="p-6 pt-0 text-center">
                            ...
                            <h3 className="mt-5 mb-6 text-lg text-gray-500">Are you sure you want to delete user #{id}?</h3>
