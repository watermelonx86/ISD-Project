        ...
        <Card className="overflow-hidden xl:col-span-3 border border-blue-gray-100 shadow-sm">
          ...
          >
            <div>
              <Typography variant="h6" color="blue-gray" className="mb-1">
                Top sản phẩm bảo hiểm được mua nhiều nhất
              </Typography>
              <Typography
                variant="small"
                className="flex items-center gap-1 font-normal text-gray-600"
              >
                <CheckCircleIcon strokeWidth={3} className="h-4 w-4 text-gray-400" />
          ...
          <CardBody className="overflow-x-scroll px-0 pt-0 pb-2">
            <table className="w-full min-w-[640px] table-auto">
              ...
              <tbody>
                {/* Phần hiển thị top sản phẩm bảo hiểm bán chạy */}
                {topProductData.map(
                  ({ name, budget, completion }, key) => {
                    const className = `py-3 px-6 ${
                      key === topProductData.length - 1
                        ? ""
