...
export function AddProduct(
    {isOpen, handleClose, handleSubmit, drawerRef, 
     name, setName, price, setPrice, desc, setDesc, discount, setDiscount}) 
{


    return (
        <div>
            <div ref={drawerRef} className={`fixed top-0 right-0 z-40 w-full h-screen max-w-xs p-4 overflow-y-auto transition-transform 
                ${isOpen ? "" : "translate-x-full"} bg-white`}
                tabIndex="-1"
                ...
                <form action="#" onSubmit={(e) => handleSubmit(e)}>
                    <div className="space-y-4">
                        ...
                        <div>
                            <label htmlFor="discount-create" className="block mb-2 text-sm font-medium text-gray-900">Discount</label>
                            <select id="discount-create" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5"
                                    value={discount}
                    ...
                    <div className="bottom-0 left-0 flex justify-center w-full pb-4 space-x-4 md:px-4 md:absolute">
                        <button type="submit" className="text-white w-full justify-center bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center"
