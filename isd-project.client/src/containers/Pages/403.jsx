...
import image from "../../assets/403_Error.svg";
        ...
        <React.Fragment>
            <div className="flex flex-col justify-center items-center px-6 mx-auto h-screen xl:px-0 dark:bg-gray-900">
                <div className="block md:max-w-lg">
                    <img src={image} alt="astronaut image" className='w-[473px]'/>
                </div>
                <div className="text-center xl:max-w-4xl">
                    ...
                    <NavLink to="/" className="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center mr-3">
